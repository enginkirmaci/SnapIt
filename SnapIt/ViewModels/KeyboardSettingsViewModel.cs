...
namespace SnapIt.ViewModels
{
    public class KeyboardSettingsViewModel : BindableBase
    {
        ...
        public string MoveUpShortcut { get { moveUpShortcut = settingService.Settings.MoveUpShortcut; return moveUpShortcut; } set { settingService.Settings.MoveUpShortcut = value; SetProperty(ref moveUpShortcut, value); ApplyChanges(); } }
        public string MoveDownShortcut { get { moveDownShortcut = settingService.Settings.MoveDownShortcut; return moveDownShortcut; } set { settingService.Settings.MoveDownShortcut = value; SetProperty(ref moveDownShortcut, value); ApplyChanges(); } }
        public string MoveLeftShortcut { get { moveLeftShortcut = settingService.Settings.MoveLeftShortcut; return moveLeftShortcut; } set { settingService.Settings.MoveLeftShortcut = value; SetProperty(ref moveLeftShortcut, value); ApplyChanges(); } }
        public string MoveRightShortcut { get { moveRightShortcut = settingService.Settings.MoveRightShortcut; return moveRightShortcut; } set { settingService.Settings.MoveRightShortcut = value; SetProperty(ref moveRightShortcut, value); ApplyChanges(); } }
