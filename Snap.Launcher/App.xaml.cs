...
public partial class App
{
    ...
    protected override Window CreateShell()
    {
        ...
        Log.Logger.Information("Snap.Launcher Started");
    ...
    protected override void RegisterTypes(IContainerRegistry containerRegistry)
    {
        ...
        containerRegistry.AddTransientFromNamespace("Snap.Launcher.Views", Assembly);
        containerRegistry.AddTransientFromNamespace("Snap.Launcher.ViewModels", Assembly);
